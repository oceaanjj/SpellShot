(function () {
  ...
  const HIT_EFFECTS = {
    default: {
      ...
      sizeMin:   2, sizeMax: 4,
      decay:     0.022, gravity: 0.06, drag: 0.96,
      shape:     'circle',
      blendMode: 'lighter',
    ...
    fire: {
      ...
      sizeMin:   2, sizeMax: 5,
      decay:     0.016, gravity: -0.10, drag: 0.97, // rises like flame
      shape:     'circle',
      blendMode: 'lighter',
    ...
    spike: {
      ...
      count:     28,
      speedMin:  5, speedMax: 13,
      sizeMin:   1.5, sizeMax: 3.5,
      decay:     0.020, gravity: 0.05, drag: 0.94,
    ...
    skull: {
      ...
      sizeMin:   2,   sizeMax: 5,
      decay:     0.012, gravity: -0.04, drag: 0.98, // float upward slowly
      shape:     'circle',
      blendMode: 'screen',
    ...
    toxic: {
      ...
      sizeMin:   3, sizeMax: 6,    // bigger blobs
      decay:     0.014, gravity: 0.12, drag: 0.93, // heavy splat
      shape:     'circle',
      blendMode: 'lighter',
    ...
    shadow: {
      ...
      sizeMin:   3, sizeMax: 7,
      decay:     0.010, gravity: -0.02, drag: 0.97, // slowly expands
    ...
    pink: {
      ...
      speedMin:  3, speedMax: 9,
      sizeMin:   2, sizeMax: 4,
      decay:     0.018, gravity: -0.06, drag: 0.97,
      shape:     'heart',
      blendMode: 'lighter',
    ...
    star: {
      ...
      sizeMin:   2, sizeMax: 5,
      decay:     0.018, gravity: 0.04, drag: 0.95,
      shape:     'star',
      blendMode: 'lighter',
    ...
    void: {
      ...
      sizeMin:   2, sizeMax: 5,
      decay:     0.013, gravity: 0.00, drag: 0.98,
      shape:     'ring',
      blendMode: 'lighter',
