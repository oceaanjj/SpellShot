...
function buildSettingsModal() {
  ...
  toggleBtn.src = aimGuideOn
    ? "assets/button/offButton.png"
    : "assets/button/onButton.png";
  ...
  (
    document.getElementById("container") || document.getElementById("gameShell")
  ).appendChild(settingsModal);
}
